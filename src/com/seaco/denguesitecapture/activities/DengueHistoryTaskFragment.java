...
public class DengueHistoryTaskFragment extends Fragment {
	...
	public DengueHistoryTaskFragment(String userEmail, String userName, String userID) {
		email = userEmail;
		name = userName;
		id = userID;
		...
		class GetJSON extends AsyncTask<Void, Void, String> {
			...
			protected String doInBackground(Void... params) {
				RequestHandler rh = new RequestHandler();
					String s = rh.sendGetRequest(Config.URL_GET_ALL_PHOTOS_CLAIM);
					return s;
			}
		}
		...
		class GetTask extends AsyncTask<Void,Void,String>{
			...
			protected void onPostExecute(String t) {
				...
				try {
					...
					if(decisionOfficer.equals("1")){history_status.setText("Viewed");}
						else if(decisionOfficer.equals("2")){history_status.setText("In Process");}
							else if(decisionOfficer.equals("3")){history_status.setText("Resolved");}
								else if(decisionOfficer.equals("0")){history_status.setText("Rejected");}
									else{history_status.setText("");}
