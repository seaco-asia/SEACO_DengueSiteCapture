				...
				if(i<result.length()){
					...
					history_detail.setOnClickListener(new View.OnClickListener() {
						public void onClick(View v) {
							...
							Log.d(TAG, "historyID["+id+"] historyFilename["+filename+"]");
							DengueHistoryTaskDetailFragment dengueHistoryTaskDetailFragment = new DengueHistoryTaskDetailFragment(id, name, historyID, filename, gps, reportDate, reportBy, photoDesc);
							FragmentManager fm = getFragmentManager();
							FragmentTransaction fragmentTransaction = fm.beginTransaction();
